...
{
    public class BLRequestService : BLBase<RequestService>
    {
        public override void OnSubmitEntity(RequestService entity, System.Data.EntityState state, Dictionary<string, object> originalValues)
        {
