...
{
    public class BLRequestVehicle : BLBase<RequestVehicle>
    {
        public override void OnSubmitEntity(RequestVehicle entity, System.Data.EntityState state, Dictionary<string, object> originalValues)
        {
