...
function(logger, com, app, router,viewController) {
    var activate = function(param) {
        ...
        pager(new helper.pager(context, inputs));
    ...
    var init = function() {
        ...
        var navigarions = [
           ...
           "CreatedByUser",
           "InputDetails",
           "InputDetails.ItemGood",
           "InputDetails.ItemGood.Scale"
        ];
    ...
    var add = function() {
        var newEntity = context.addEntity('Input',
            {
                No: 0,
                SectionID: null,
                PersonID: null,
    ...
    var addDetail = function (item) {
        var newEntity = context.addEntity('InputDetail',
            {
                ItemGood: null,
                ItemGoodID: null,
                Input: item,
