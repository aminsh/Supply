...
window.bootbox = window.bootbox || (function init($, undefined) {
    ...
    var templates = {
        dialog:
          "<div class='bootbox modal' tabindex='-1' role='dialog' style='top: 40%;'>" +
            "<div class='modal-dialog'>" +
              "<div class='modal-content'>" +
                "<div class='modal-body' style='padding:30px'><div class='bootbox-body'></div></div>" +
              "</div>" +
            "</div>" +
          "</div>",
        header:
          ...
          "</div>",
        footer:
          "<div class='modal-footer' style='text-align: left;font-family=tahoma'></div>",
        closeButton:"",
